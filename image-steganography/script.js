...
function encodeMessage() {
  ...
  var nameVal = document.forms["simpleForm"]["message"].value;
  var namegambar = document.forms["simpleForm"]["baseFile"].value;
  ...
  if(namegambar == "") {
    Swal.fire({
      icon: 'error',
      title: 'Oops...',
      text: 'Please Fill in the image field!',
    })
    // document.getElementsByClassName( "errorMessagegambar" )[0].style.visibility = "visible";
    // document.getElementsByClassName( "errorMessagegambar" )[0].innerHTML = "Please Fill out this field";
  return false;
  } else if( nameVal == "") {
    Swal.fire({
      icon: 'error',
  ...
  return false;
  }  else if((text.length * 8) > (width * height * 3)) {
    Swal.fire({
      icon: 'error',
      title: 'Oops...',
